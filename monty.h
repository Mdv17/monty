...
void mdv_pchar(stack_t **head, unsigned int counter);
void mdv_pstr(stack_t **head, unsigned int counter);
void mdv_rotl(stack_t **head, unsigned int counter);
void mdv_rotr(stack_t **head, __attribute__((unused)) unsigned int counter);
